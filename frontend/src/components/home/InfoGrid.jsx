    ...
    <section id="about" className="pb-10 pt-1 sm:pb-12 sm:pt-2 md:pb-16 md:pt-3 lg:pb-20">
      <Container>
        <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-5 xl:grid-cols-4 xl:gap-6">
          ...
          >
            <div className="relative flex h-full w-full flex-col overflow-hidden rounded-2xl border border-primary bg-card/90 p-5 shadow-[0_24px_80px_rgb(0_0_0_/_0.55)] backdrop-blur-xl sm:p-6 md:p-7">
              <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_rgb(132_211_33_/_0.14),_transparent_55%)]" />
              <div className="relative flex flex-1 flex-col">
                <span className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-primary/40 bg-primary/10 text-primary">
                  <FaCalendarAlt size={16} />
                </span>
                <h3 className="mt-4 font-display text-lg font-bold uppercase tracking-[0.12em] text-primary sm:text-xl">
                  Book a Slot
                </h3>
                <p className="mt-2 flex-1 text-sm leading-relaxed text-muted">
                  See live availability, tap free hours on a slot grid, and
                  confirm in seconds — same flow as popular turf booking apps.
                </p>
                <ul className="mt-4 space-y-1.5 text-xs text-muted sm:text-sm">
                  <li className="flex items-center gap-2">
                    <HiCheckCircle className="text-primary" size={14} />
                    Date strip + calendar
                  </li>
                  <li className="flex items-center gap-2">
                    <HiCheckCircle className="text-primary" size={14} />
                    Morning to overnight slots
                  </li>
                  <li className="flex items-center gap-2">
                    <HiCheckCircle className="text-primary" size={14} />
                    Live price estimate
                ...
                <Link
                  to="/book"
                  className="mt-6 inline-flex w-full items-center justify-center rounded-xl bg-primary px-4 py-3.5 text-sm font-bold uppercase tracking-[0.08em] text-bg shadow-[0_0_28px_rgb(132_211_33_/_0.35)] transition hover:brightness-110"
                >
                  Book Slot
                </Link>
              </div>
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-5 inline-flex items-center justify-center rounded-full border border-primary/40 px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-primary transition hover:bg-primary/10"
            >
              Open in Maps
            </a>
          </motion.article>
