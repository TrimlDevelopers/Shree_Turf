      ...
      <Container className="relative flex h-full flex-col justify-end pb-8 pt-16 sm:justify-center sm:pb-28 sm:pt-40 md:min-h-[100svh] md:justify-center md:py-36 md:pt-56">
        ...
        >
          <span className="sr-only">
            {siteInfo.name} — Football and Cricket Turf in Ichalkaranji.{' '}
          </span>
        ...
        >
          ...
          <motion.div
            variants={item}
            className="relative z-20 mt-7 flex w-full flex-col items-center justify-center gap-3 sm:mt-8 sm:w-auto sm:flex-row sm:flex-wrap sm:gap-4"
          >
            <motion.div
